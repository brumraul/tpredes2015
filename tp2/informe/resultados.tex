...
Podemos ver en \ref{table:mit}, \ref{histo:mit} y \ref{lines:mit} que el $\Delta$RTT correspondiente a los $TTL$ $8$, $16$, $19$ y en menor medida $21$, son mas grande que el resto. En las siguientes secciones se analizará si estos corresponden a transmiciones por enlaces submarinos.
...
En \ref{table:mit} se obserba que los saltos distinguidos corresponden efectivamente a enlaces submarinos. En el mapa \ref{mapa:mit} se puede apreciar el enlace intercontinental. Los saltos 6 y 7 aparecen en el mapa con el nombre de ``A'' y ``B'' respectivamente.
...
Vemos, nuevamente, en \ref{mapa:mit} que los outliers encontrados corresponden a enlaces submarinos.
