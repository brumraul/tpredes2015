...
De los resultados obtenidos deducimos entonces que la distribución de los $\Delta$RTT es ``Normal'', igualmente como mencionamos en la sección \ref{desarrollo:stats} correremos el test de Grubbs a fin de corroborar luego si encuentra los enlaces submarinos de todas formas.\\
Los resultados obtenidos fueron los siguientes outliers:
